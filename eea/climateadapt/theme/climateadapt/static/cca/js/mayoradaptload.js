...
require([
  ...
  */
    ...
    function criteriaFilter() {
        ...
        var url = "/@@cities_listing.json?countries=&sectors=" + sectors_id + "&climate_impacts=" + impacts_id + "&city_stage=" + stages_id;
    ...
    function zoneFilter() {
        ...
        $.ajax({
            url: "/@@cities_listing.json?countries=" + pais_id + "&sectors=&climate_impacts=&city_stage=",
            processData: true,
            async: true,
            type: "GET",
            dataType: "json",
