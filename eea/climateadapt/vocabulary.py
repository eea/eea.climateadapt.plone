...
_intended_user_groups_tool = [
    ("COMMISSION_SERVICE_AND_OR_AGENCIES", _(
        "Commission services and/or Agencies")),
...
type_of_data_tool_vocabulary = generic_vocabulary(
    _type_of_data_tool, sort=False)
...
data_sources_tool_vocabulary = generic_vocabulary(
    _data_sources_tool, sort=False)
...
license_status_tool_vocabulary = generic_vocabulary(
    _license_status_tool, sort=False)
...
relevant_eu_policies = [
    ...
    ("EU_CIRCULAR_ECONOMY", _("Circular Economy Act")),
    ...
    ("EU_BUILDINGS_ENERGY", _("Energy Performance of Buildings Directive")),
    ("EU_ENERGY", _("Energy policy")),
    ...
    ("EU_LULUCF", _("LULUCF Regulation")),
    ("EU_MARINE", _("Marine Strategy Framework Directive")),
    ("EU_MARITIME_SECURITY", _("Maritime security strategy")),
    ("EU_MSP", _("Maritime Spatial Planning (MSP) Directive")),
    ("EU_NATURE_RESTORATION", _("Nature Restoration Law")),
    ("EU_FOREST_2030", _("New EU Forest strategy for 2030")),
    ("EU_CULTURE_2018", _("New European Agenda for Culture (2018)")),
    ("EU_BAUHAUS", _("New European Bauhaus")),
    ...
    ("EU_SOLIDARITY_FUND", _("The EU solidarity fund (EUSF)")),
    ("EU_TOURISM_TRANSITION", _("Transition pathway for tourism")),
    ("EU_WFD", _("Water framework Directive")),
    ("EU_WATER_RESILIENCE", _("Water Resilience Strategy")),
...
RELEVANT_EU_POLICY_URLS = {
    "EU_ANIMAL_HEALTH": "https://food.ec.europa.eu/animals/animal-health/animal-health-law_en",
    "EU_ANIMAL_HEALTH_STRATEGY": "https://food.ec.europa.eu/animals/animal-health/eu-animal-health-strategy-2007-2013_en",
    "EU_BATHING_WATER": "https://environment.ec.europa.eu/topics/water/bathing-water_en",
    "EU_BIODIVERSITY_2030": "https://environment.ec.europa.eu/strategy/biodiversity-strategy-2030_en",
    "EU_BIRDS": "https://environment.ec.europa.eu/topics/nature-and-biodiversity/birds-directive_en",
    "EU_CIRCULAR_ECONOMY": "https://environment.ec.europa.eu/strategy/circular-economy-action-plan_en",
    "EU_CIVIL_PROTECTION": "https://ec.europa.eu/echo/what/civil-protection/mechanism_en",
    "EU_CAP": "https://agriculture.ec.europa.eu/common-agricultural-policy/cap-overview/cap-glance_en",
    "EU_CFP": "https://oceans-and-fisheries.ec.europa.eu/policy/common-fisheries-policy-cfp_en",
    "EU_HEALTH_UNION": "https://commission.europa.eu/document/download/98c6e4dc-0fc3-4ec6-8ec2-bfcdcb2f018a_en?filename=policy_com-2024-206_en.pdf",
    "EU_CONCESSIONS": "https://eur-lex.europa.eu/eli/dir/2014/23/oj",
    "EU_CRITICAL_ENTITIES": "https://home-affairs.ec.europa.eu/policies/internal-security/counter-terrorism-and-radicalisation/protection/critical-infrastructure-resilience-eu-level_en#directive-on-the-resilience-of-critical-entities",
    "EU_ENERGY_EFFICIENCY": "https://energy.ec.europa.eu/topics/energy-efficiency/energy-efficiency-targets-directive-and-rules/energy-efficiency-directive_en",
    "EU_BUILDINGS_ENERGY": "https://energy.ec.europa.eu/topics/energy-efficiency/energy-efficient-buildings/nearly-zero-energy-and-zero-emission-buildings_en",
    "EU_ENERGY": "https://energy.ec.europa.eu/index_en",
    "EU_TOURISM_2030": "https://data.consilium.europa.eu/doc/document/ST-15441-2022-INIT/en/pdf.",
    "EU_FARM_TO_FORK": "https://food.ec.europa.eu/horizontal-topics/farm-fork-strategy_en",
    "EU_FLOODS": "https://environment.ec.europa.eu/topics/water/floods_en",
    "EU_GLOBAL_HEALTH": "https://health.ec.europa.eu/publications/eu-global-health-strategy-better-health-all-changing-world_en",
    "EU_GREEN_INFRA": "https://ec.europa.eu/environment/nature/ecosystems/strategy/index_en.htm",
    "EU_GROUNDWATER": "http://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2006:372:0019:0031:EN:PDF",
    "EU_HABITATS": "https://environment.ec.europa.eu/topics/nature-and-biodiversity/habitats-directive_en",
    "EU_LULUCF": "https://climate.ec.europa.eu/news-other-reads/news/regulation-land-use-land-use-change-and-forestry-2030-climate-and-energy-framework-adopted-2018-05-14_en",
    "EU_MARINE": "https://research-and-innovation.ec.europa.eu/research-area/environment/oceans-and-seas/eu-marine-strategy-framework-directive_en",
    "EU_MARITIME_SECURITY": "https://oceans-and-fisheries.ec.europa.eu/ocean/blue-economy/other-sectors/maritime-security-strategy_en",
    "EU_MSP": "https://oceans-and-fisheries.ec.europa.eu/ocean/blue-economy/maritime-spatial-planning_en",
    "EU_NATURE_RESTORATION": "https://environment.ec.europa.eu/topics/nature-and-biodiversity/nature-restoration-regulation_en",
    "EU_FOREST_2030": "https://commission.europa.eu/document/cf3294e1-8358-4c93-8de4-3e1503b95201_en",
    "EU_CULTURE_2018": "https://culture.ec.europa.eu/culture/node/88?",
    "EU_BAUHAUS": "https://new-european-bauhaus.europa.eu/index_en",
    "EU_OCEAN_PACT": "https://oceans-and-fisheries.ec.europa.eu/european-ocean-pact_en",
    "EU_ORGANIC": "https://agriculture.ec.europa.eu/farming/organic-farming/organic-production-and-products_en",
    "EU_PUBLIC_PROCUREMENT": "https://single-market-economy.ec.europa.eu/single-market/public-procurement_en",
    "EU_ICZM": "https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32002H0413&from=EN",
    "EU_HEALTH_THREATS": "https://www.consilium.europa.eu/en/policies/protecting-against-cross-border-health-threats/#cross%20border%20health%20threats",
    "EU_SOLVENCY_II": "https://finance.ec.europa.eu/banking/insurance/insurance-regulation_en",
    "EU_AQUACULTURE_2030": "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=COM:2021:236:FIN",
    "EU_HEALTH_PLAN_2020_24": "https://commission.europa.eu/publications/strategic-plan-2020-2024-health-and-food-safety_en",
    "EU_MOBILITY": "https://eur-lex.europa.eu/legal-content/EN/AUTO/?uri=CELEX:52020DC0789",
    "EU_TEN_T": "https://transport.ec.europa.eu/transport-themes/infrastructure-and-investment/trans-european-transport-network-ten-t_en",
    "EU_SOLIDARITY_FUND": "https://ec.europa.eu/regional_policy/policy/what/glossary/eu-solidarity-fund_en",
    "EU_TOURISM_TRANSITION": "https://op.europa.eu/en/publication-detail/-/publication/404a8144-8892-11ec-8c40-01aa75ed71a1",
    "EU_WFD": "https://environment.ec.europa.eu/topics/water/water-framework-directive_en",
    "EU_WATER_RESILIENCE": "https://commission.europa.eu/topics/environment/water-resilience-strategy_en",
