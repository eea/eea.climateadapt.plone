...
SUBNATIONAL_REGIONS = {
   ...
   "SUBN_Tees_Valley_and_Durham__U": "Tees Valley and Durham (GB)",
   "SUBN_Northumberland_and_Tyne_a": "Northumberland and Tyne and Wear (GB)",
   "SUBN_Cumbria__GB_": "Cumbria (GB)",
   "SUBN_Greater_Manchester__GB_": "Greater Manchester (GB)",
   "SUBN_Lancashire__GB_": "Lancashire (GB)",
   "SUBN_Cheshire__GB_": "Cheshire (GB)",
   "SUBN_Merseyside__GB_": "Merseyside (GB)",
   "SUBN_East_Yorkshire_and_Northe": "East Yorkshire and Northern Lincolnshire (GB)",
   "SUBN_North_Yorkshire__GB_": "Yorkshire (GB)",
   "SUBN_West_Yorkshire__GB_": "West Yorkshire (GB)",
   "SUBN_Derbyshire_and_Nottingham": "Derbyshire and Nottinghamshire (GB)",
   "SUBN_Leicestershire__Rutland_a": "Leicestershire, Rutland and Northamptonshire (GB)",
   "SUBN_Lincolnshire__GB_": "Lincolnshire (GB)",
   "SUBN_Herefordshire__Worcesters": "Herefordshire, Worcestershire and Warwickshire (GB)",
   "SUBN_Shropshire_and_Staffordsh": "Shropshire and Staffordshire (GB)",
   "SUBN_West_Midlands__GB_": "West Midlands (GB)",
   "SUBN_East_Anglia__GB_": "East Anglia (GB)",
   "SUBN_Bedfordshire_and_Hertford": "Bedfordshire and Hertfordshire (GB)",
   "SUBN_Essex__GB_": "Essex (GB)",
   "SUBN_Inner_London_WEST__GB_": "Inner London - WEST (GB)",
   "SUBN_Inner_London_EAST__GB_": "Inner London - EAST (GB)",
   "SUBN_Outer_London_ENE__GB_": "Outer London - East and North East (GB)",
   "SUBN_Outer_London_S__GB_": "Outer - London South (GB)",
   "SUBN_Outer_London_WNW__GB_": "Outer London - West and North West (GB)",
   "SUBN_Berkshire__Buckinghamshir": "Berkshire, Buckinghamshire and Oxfordshire (GB)",
   "SUBN_Surrey__East_and_West_Sus": "Surrey, East and West Sussex (GB)",
   "SUBN_Hampshire_and_Isle_of_Wig": "Hampshire and Isle of Wight (GB)",
   "SUBN_Kent__GB_": "Kent (GB)",
   "SUBN_Gloucestershire__Wiltshir": "Gloucestershire, Wiltshire and Bristol/Bath area (GB)",
   "SUBN_Dorset_and_Somerset__GB_": "Dorset and Somerset (GB)",
   "SUBN_Cornwall_and_Isles_of_Sci": "Cornwall and Isles of Scilly (GB)",
   "SUBN_Devon__GB_": "Devon (GB)",
   "SUBN_West_Wales_and_The_Valley": "West Wales and The Valleys (GB)",
   "SUBN_East_Wales__GB_": "East Wales (GB)",
   "SUBN_Eastern_Scotland__GB_": "Eastern Scotland (GB)",
   "SUBN_South_Western_Scotland__U": "South Western Scotland (GB)",
   "SUBN_North_Eastern_Scotland__U": "North Eastern Scotland (GB)",
   "SUBN_Highlands_and_Islands__UK": "Highlands and Islands (GB)",
   "SUBN_Northern_Ireland__GB_": "Northern Ireland (GB)",
   "SUBN_Extra_Regio_NUTS_2__GB_": "Extra-Regio NUTS 2 (GB)",
   }
