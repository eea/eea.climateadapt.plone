...
SUBNATIONAL_REGIONS = {
   ...
   "SUBN_Aττική__Attiki__EL_": "Aττική (Attiki) (EL)",
   "SUBN_Βόρειο_Αιγαίο__Voreio_Aig__EL_": "Βόρειο Αιγαίο (Voreio Aigaio) (EL)",
   "SUBN_Νότιο_Αιγαίο__Notio_Aigai__EL_": "Νότιο Αιγαίο (Notio Aigaio) (EL)",
   "SUBN_Κρήτη__Kriti__EL_": "Κρήτη (Kriti) (EL)",
   "SUBN_Aνατολική_Μακεδονία__Θράκ__EL_": "Aνατολική Μακεδονία, Θράκη (Anatoliki Makedonia, Thraki) (EL)",
   "SUBN_Κεντρική_Μακεδονία__Kentr__EL_": "Κεντρική Μακεδονία (Kentriki Makedonia) (EL)",
   "SUBN_Δυτική_Μακεδονία__Dytiki__EL_": "Δυτική Μακεδονία (Dytiki Makedonia) (EL)",
   "SUBN_Θεσσαλία__Thessalia__EL_": "Θεσσαλία (Thessalia) (EL)",
   "SUBN_Ιόνια_Νησιά__Ionia_Nisia__EL_": "Ιόνια Νησιά (Ionia Nisia) (EL)",
   "SUBN_Δυτική_Ελλάδα__Dytiki_Ell__EL_": "Δυτική Ελλάδα (Dytiki Ellada) (EL)",
   "SUBN_Στερεά_Ελλάδα__Sterea_Ell__EL_": "Στερεά Ελλάδα (Sterea Ellada) (EL)",
   "SUBN_Πελοπόννησος__Peloponniso__EL_": "Πελοπόννησος (Peloponnisos) (EL)",
   ...
   "SUBN_North_Yorkshire__UK_": "Yorkshire (UK)",
   ...
   "SUBN_Inner_London_WEST__UK_": "Inner London - WEST (UK)",
   "SUBN_Inner_London_EAST__UK_": "Inner London - EAST (UK)",
   "SUBN_Outer_London_ENE__UK_": "Outer London - East and North East (UK)",
   "SUBN_Outer_London_S__UK_": "Outer - London South (UK)",
   "SUBN_Outer_London_WNW__UK_": "Outer London - West and North West (UK)",
