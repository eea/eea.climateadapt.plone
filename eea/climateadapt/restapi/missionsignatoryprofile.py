...
DISCODATA_URLS = {
    "governance": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Governance_Template_Text%5D&p=1&nrOfHits=10000",
    "assessment_text": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Assessment_Template_Text%5D&p=1&nrOfHits=10000",
    "assessment_factors": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Assessment_Template_Factors_Text%5D&p=1&nrOfHits=10000",
    "assessment_risks": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Assessment_Template_Climate_Risk_Assessments_Text%5D&p=1&nrOfHits=10000",
    "assessment_hazards_sectors": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Assessment_Template_Hazards_Sectors_Text%5D&p=1&nrOfHits=10000",
    "action_text": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Action_Template_Text%5D&p=1&nrOfHits=10000",
    "action_actions": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Action_Template_Actions_Text%5D&p=1&nrOfHits=10000",
    "action_hazards": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Action_Template_Climate_Hazards_Text%5D&p=1&nrOfHits=10000",
    "action_sectors": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Action_Template_Sectors_Text%5D&p=1&nrOfHits=10000",
    "action_benefits": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Action_Template_Co_Benefits_Text%5D&p=1&nrOfHits=10000",
    "planning_titles": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Planning_Template_Adaptation_Text%5D&p=1&nrOfHits=10000",
    "planning_goals": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Planning_Template_Adaptation_Goals_Text%5D&p=1&nrOfHits=10000",
    "planning_goals_hazard": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Planning_Template_Adaptation_Goals_Climate_Hazards_Text%5D&p=1&nrOfHits=10000",
    "planning_climate_action": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Planning_Template_Climate_Action_Plan_Text%5D&p=1&nrOfHits=10000",
    "planning_climate_action_sectors": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Planning_Template_Climate_Action_Plan_Sectors_Text%5D&p=1&nrOfHits=10000",
    "tabs_labels": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Tabs_Text%5D&p=1&nrOfHits=10000",
    "footer_text": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_Footer_Text%5D&p=1&nrOfHits=10000",
    "general_text": "https://discodata.eea.europa.eu/sql?query=SELECT%20TOP%2010000%20*%20FROM%20%5B"+DISCODATA_PATH+"%5D.%5B"+DISCODATA_VERSION+"%5D.%5Bv_General_Text%5D&p=1&nrOfHits=10000",
}
