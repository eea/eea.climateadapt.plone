...
from eea.climateadapt.interfaces import ICCACountry2026
...
@adapter(ICCACountry2026, Interface)
class CountryProfile2026(object):
    """An expander that automatically inserts the HTML rendering of a country profile view
    (the @@country-profile-2026) into the components of country profile serialization
    """
